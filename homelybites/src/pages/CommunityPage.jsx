            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6">
                <div className="text-center mb-6">
                  <div className="w-20 h-20 mx-auto rounded-2xl overflow-hidden mb-4 shadow-md">
                    <img 
              ...
              {/* Navigation */}
              <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6">
                <h3 className="text-lg font-bold text-gray-800 mb-6 uppercase tracking-wide">Navigation</h3>
                <nav className="space-y-4">
                  <a href="#" className="flex items-center gap-3 text-gray-600 hover:text-red-500 transition-colors p-2 rounded-xl hover:bg-gray-50">
              ...
              {/* Categories */}
              <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6">
                <h3 className="text-lg font-bold text-gray-800 mb-6 uppercase tracking-wide">Categories</h3>
                <nav className="space-y-3">
                  {categories.map((category) => (
                    <button 
                      key={category}
                      onClick={() => handleCategoryChange(category)}
                      className={`block w-full text-left p-2 rounded-xl transition-all duration-200 font-medium ${
              ...
              <div className="px-6 md:px-8 lg:px-12 space-y-6">
                ...
                <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6">
                  <div className="flex items-center bg-gray-50 rounded-2xl p-4">
                    ...
                    <span className="text-gray-600 flex-1 font-medium">Let's Swap Stories, Recipes & Smiles</span>
                ...
                {posts.map((post) => (
                  <div key={post.id} className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
                    ...
                    <div className="p-6 flex items-center">
                      ...
                      <div>
                        <h4 className="text-lg font-bold text-gray-800">{post.author.name}</h4>
                      ...
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        >
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 ${
                            post.isLiked ? 'bg-red-100' : 'bg-gray-100 hover:bg-gray-200'
                          }`}>
                            <Heart 
                              className={`w-5 h-5 ${
                        ...
                        >
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 ${
                            post.isSaved ? 'bg-red-100' : 'bg-gray-100 hover:bg-gray-200'
                          }`}>
                            <Bookmark 
                              className={`w-5 h-5 ${
