      ...
      <img
        ...
        onError={(e) => {
          e.target.parentElement.innerHTML =
            '<div class="w-full h-full bg-orange-200 flex items-center justify-center"><span class="text-xs text-orange-600">IMG</span></div>';
        }}
      />
    </div>
        ...
        <div className="flex-1 p-3 sm:p-4 lg:p-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8 leading-relaxed px-2 sm:px-0">
              Chicken Momo is a popular South Asian dumpling, especially loved
              in Nepal, Tibet, and parts of India. It consists of a spiced
              chicken filling wrapped in a thin dough and is usually steamed,
              though it can also be fried or pan-fried. It's a flavorful and
              satisfying snack or meal, often served with a tangy tomato-based
              dipping sauce.
            </p>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-8 mb-6 sm:mb-8 px-2 sm:px-0">
              ...
              <div className="order-2 xl:order-1">
                ...
                <div className="bg-red-50 p-3 sm:p-4 rounded-lg">
                  <h3 className="font-semibold text-red-400 mb-3 text-sm sm:text-base">
                    Nutritional Facts
                  </h3>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    ...
                    <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
                      Mix flour and salt, then add water gradually to form a
                      soft, non-sticky dough. Cover and let rest for 30 minutes.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
                      In a bowl, combine ground chicken, onion, spring onion,
                      garlic, ginger, soy sauce, cumin, pepper, salt, and oil.
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
                      Roll the dough into small balls. Flatten and roll into
                      thin circles (3 inches wide). Add 1 tbsp filling in the
                      center. Fold and pleat the edges to seal.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
                      Place momos in a steamer lined with parchment or cabbage
                      leaves. Steam over boiling water for 10-12 minutes or
                      until the dough turns glossy and translucent.
                    </p>
                  </div>
