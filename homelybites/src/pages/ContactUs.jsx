...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-t from-vrless from-60% to-white flex flex-col">
      {/* Navbar - Fixed at top */}
      <Navbar />
      
      {/* Main Content - Takes remaining space */}
      <div className="flex-1 px-4 sm:px-6 md:px-9 py-6 sm:py-9">
        {/* Header */}
            ...
            <div className="flex-1">
              <div className="space-y-6 sm:space-y-8">
                ...
                <button
                  ...
                  className="bg-red-400 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-md font-medium hover:bg-red-500 transition-colors w-full sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
                >
